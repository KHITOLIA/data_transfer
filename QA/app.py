...
app = Flask(__name__)
app.secret_key = "secret_key_for_session"  # Needed to store score in session

questions = [
    # {
    #     "question": "What will print('Hello {}'.format('World')) output?",
    #     "options": ["Hello {}", "Hello World", "World Hello", "format error"],
    #     "answer": "Hello World"
    # },
    # {
    #     "question": "What is the correct way to check equality in Python?",
    #     "options": ["=", "==", "===", "!="],
    #     "answer": "=="
    # },
    # {
    ...
    #     "options": ["2name", "my-name", "name_2", "@name"],
    #     "answer": "name_2"
    # },
    # {
    #     "question": "What will be the output of print(type(10))?",
    #     "options": ["<class 'str'>", "<class 'int'>", "<type 'int'>", "<int>"],
    #     "answer": "<class 'int'>"
    # },
    # {
    #     "question": "Which of the following is a Python keyword?",
    #     "options": ["define", "function", "return", "integer"],
    #     "answer": "return"
    # },
    # {
    ...
    #     "options": ["Adds elements", "Deletes string", "Returns length", "Converts type"],
    ...
    # },
    # {
    #     "question": "What is the output of 'abc' + 'def'?",
    #     "options": ["abcdef", "abc def", "abc+def", "Error"],
    #     "answer": "abcdef"
    # },
    # {
    #     "question": "Which function is used to convert a string to lowercase?",
    #     "options": ["lowercase()", "strlower()", "lower()", "tolower()"],
    #     "answer": "lower()"
    # },
    # {
    ...
    #     "options": ["function()", "def", "fun", "start"],
    #     "answer": "def"
    # },
    # {
    ...
    #     "options": ["A list", "An int", "A tuple", "A sequence"],
    #     "answer": "A sequence"
    # },
    # {
    ...
    #     "answer": "None" # Python doesn't have a direct do-while loop
    # },
    # {
    ...
    #     "options": ["Skips to next iteration", "Ends loop", "Restarts loop", "None"],
    #     "answer": "Ends loop"
    # },
    # {
    ...
    #     "options": ["<class 'list'>", "<list>", "<type 'list'>", "list"],
    #     "answer": "<class 'list'>"
    # },
    # {
...
def quiz():
    ...
    selected_option = session["selected"].get(str(current_q), None)
    ...
    if request.method == "POST":
        ...
        if selected_option:
            ...
            if selected_option == correct_answer:
                session["score"] += 1
            session["selected"][str(current_q)] = selected_option
        session["current_q"] += 1
        return redirect(url_for("quiz"))

    return render_template("quiz.html", question=question, q_num=current_q+1, total_q=total_q, selected=selected_option)
